...
func generateResourceForStruct(apiDir string, structName string, authCfg *AuthConfig) {
	...
	// Parse model struct to get fields
...
// %sDTO represents the JSON representation of %s
type %sDTO struct {
%s}
...
`,
		timeImport,
		structName, structName, structName, dtoFields,
