...
### Added
- **HTTP Compression**: Automatic gzip/deflate/brotli response compression
  - Configurable compression levels (1=speed, 2=balanced, 3=best compression)
  - Enabled by default, configurable via `server.compression_enabled` and `server.compression_level`
